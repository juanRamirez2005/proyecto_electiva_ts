...
function crearElementoPedido(pedido) {
    ...
    client.innerHTML = `
        ...
        <br>
        <small>${((_b = pedido.cliente) === null || _b === void 0 ? void 0 : _b.telefono) || 'N/A'}</small>
    `;
...
export function renderPedidosDespacho() {
...
export function inicializarRenderizadoDespacho() {
