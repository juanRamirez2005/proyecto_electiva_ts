document.addEventListener("DOMContentLoaded", () => {
  const btnImprimir = document.getElementById("btnImprimirTarjetas") as HTMLButtonElement;
  const contenedor = document.getElementById("contenedorTarjetas") as HTMLDivElement;
  ...
  btnImprimir.addEventListener("click", () => {
    ...
    tarjetasGuardadas.forEach((t: { para: string; de: string; mensaje: string }, i: number) => {
      const tarjetaHTML = `
        <div class="tarjeta">
