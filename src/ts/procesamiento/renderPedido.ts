import type { PedidoLocalStorage } from './PedidoLocalStorage.js';
 ...
 */
function agruparPorCliente(pedidos: PedidoLocalStorage[]): Record<string, PedidoLocalStorage[]> {
  const grupos: Record<string, PedidoLocalStorage[]> = {};
  
  pedidos.forEach(pedido => {
    const nombreCliente = pedido.cliente?.nombre || 'Cliente desconocido';
 ...
 */
export function renderizarPedidos(): void {
 ...
 */
export function inicializarRenderizadoPedidos(): void {
